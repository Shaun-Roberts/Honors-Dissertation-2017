degree.SD = function(ylimits = c(0,3), size = 30, step_size = 0.5){
  ...
  title(xlab = "False Negative Rate", 
        ...
        main = paste("Degree Centrality Standard Deviations\nNetwork Size (", size, ")", sep = ""))
  #Plotted lines
  {
    # f.pos.rate 0
    {f.pos.rate = 0
...
#30
pdf("degree_SD_30.pdf")
degree.SD(ylimits = c(0,3), size = 30, step_size = 0.5)
dev.off()
#100
pdf("degree_SD_100.pdf")
degree.SD(ylimits = c(0,5), size = 100, step_size = 1)
dev.off()
#250
pdf("degree_SD_250.pdf")
degree.SD(ylimits = c(0,7), size = 250, step_size = 1)
dev.off()
#500
pdf("degree_SD_500.pdf")
degree.SD(ylimits = c(0,11), size = 500, step_size = 2)
dev.off()
#1000
pdf("degree_SD_1000.pdf")
degree.SD(ylimits = c(0,15), size = 1000, step_size = 4)
dev.off()
