min.degree.dist = function(ylimits = c(0,0.5), size = 30, step_size = 0.1){
  ...
  title(xlab = "False Negative Rate", 
        ylab = "Degree", 
        main = paste("Minimum Degree Distribution\nNetwork Size (", size, ")", sep = ""))
  #Plotted lines
  {
    min.fun = function(x){
...
#30
pdf("degree_dist_min_30.pdf")
min.degree.dist(ylimits = c(0,20), size = 30, step_size = 5)
dev.off()
#100
pdf("degree_dist_min_100.pdf")
min.degree.dist(ylimits = c(0,100), size = 100, step_size = 25)
dev.off()
#250
pdf("degree_dist_min_250.pdf")
min.degree.dist(ylimits = c(0,120), size = 250, step_size = 20)
dev.off()
#500
pdf("degree_dist_min_500.pdf")
min.degree.dist(ylimits = c(0,200), size = 500, step_size = 50)
dev.off()
#1000
pdf("degree_dist_min_1000.pdf")
min.degree.dist(ylimits = c(0,360), size = 1000, step_size = 50)
dev.off()
