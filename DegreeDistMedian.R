med.degree.dist = function(ylimits = c(0,0.5), size = 30, step_size = 0.1){
  ...
  title(xlab = "False Negative Rate", 
        ylab = "Degree", 
        main = paste("Median Degree Distribution\nNetwork Size (", size, ")", sep = ""))
  #Plotted lines
  {
    med.fun = function(x){
...
#30
pdf("degree_dist_med_30.pdf")
med.degree.dist(ylimits = c(0,30), size = 30, step_size = 5)
dev.off()
#100
pdf("degree_dist_med_100.pdf")
med.degree.dist(ylimits = c(0,100), size = 100, step_size = 25)
dev.off()
#250
pdf("degree_dist_med_250.pdf")
med.degree.dist(ylimits = c(0,150), size = 250, step_size = 50)
dev.off()
#500
pdf("degree_dist_med_500.pdf")
med.degree.dist(ylimits = c(0,250), size = 500, step_size = 50)
dev.off()
#1000
pdf("degree_dist_med_1000.pdf")
med.degree.dist(ylimits = c(0,450), size = 1000, step_size = 100)
dev.off()
