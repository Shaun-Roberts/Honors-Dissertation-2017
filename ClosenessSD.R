closeness.SD = function(ylimits = c(0,15), size = 30, step_size = 5){
  ...
  title(xlab = "False Negative Rate", 
        ...
        main = paste("Closeness Centrality Standard Deviation\nNetwork Size (", size, ")", sep = ""))
  #Plotted lines
  {
    # f.pos.rate 0
    {
...
#30
pdf("closeness_SD_30.pdf")
closeness.SD(ylimits = c(0,0.003), size = 30, step_size = 0.001)
dev.off()
#100
pdf("closeness_SD_100.pdf")
closeness.SD(ylimits = c(0,0.0004), size = 100, step_size = 0.0001)
dev.off()
#250
pdf("closeness_SD_250.pdf")
closeness.SD(ylimits = c(0,0.0001), size = 250, step_size = 0.00002)
dev.off()
#500
pdf("closeness_SD_500.pdf")
closeness.SD(ylimits = c(0,0.00004), size = 500, step_size = 0.00001)
dev.off()
#1000
pdf("closeness_SD_1000.pdf")
closeness.SD(ylimits = c(0,0.00002), size = 1000, step_size = 0.000005)
dev.off()
