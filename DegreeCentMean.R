degree.Mean = function(ylimits = c(0,15), size = 30, step_size = 5){
  ...
  title(xlab = "False Negative Rate", 
        ylab = "Mean", 
        main = paste("Mean Degree Centrality\nNetwork Size (", size, ")", sep = ""))
  #Plotted lines
  {
    # f.pos.rate 0
    {
...
#30
pdf("degree_Mean_30.pdf")
degree.Mean(ylimits = c(0,15), size = 30, step_size = 5)
dev.off()
#100
pdf("degree_Mean_100.pdf")
degree.Mean(ylimits = c(0,35), size = 100, step_size = 5)
dev.off()
#250
pdf("degree_Mean_250.pdf")
degree.Mean(ylimits = c(0,70), size = 250, step_size = 10)
dev.off()
#500
pdf("degree_Mean_500.pdf")
degree.Mean(ylimits = c(0,120), size = 500, step_size = 20)
dev.off()
#1000
pdf("degree_Mean_1000.pdf")
degree.Mean(ylimits = c(0,220), size = 1000, step_size = 30)
dev.off()
